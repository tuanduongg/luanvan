...
<html lang="en" class="light-style customizer-hide" data-theme="theme-default" data-template="vertical-menu-template-free">
                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="/" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">IT Uneti manager</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2">Welcome to IT Uneti Manager 👋</h4>
                        <p class="mb-4"> </p>

                        <form id="formAuthentication" class="mb-3" action="#" method="POST">
                            <div class="mb-3">
                                <label for="email" class="form-label">Email</label>
                                <input type="text" class="form-control" id="email" name="email-username" placeholder="Nhập email" autofocus />
                            </div>
