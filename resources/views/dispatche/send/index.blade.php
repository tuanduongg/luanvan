                ...
                <div class="card-content">
                    ...
                    <div class="table-responsive h-px-500">
                        ...
                        <table class="table card-table " id="table-data">
                            <thead>
                                <tr>
                                    <th class="text-primary text-center td-stt"
                                        style="background-color: #ffff;position: sticky; top: 0; z-index: 1;">STT</th>
                                    <th class="text-primary"
                                        style="background-color: #ffff;position: sticky; top: 0; z-index: 1;">Số công văn
                                    </th>
                                    <th class="text-primary text-center"
                                        style="background-color: #ffff;position: sticky; top: 0; z-index: 1;min-width: 250px;">Tiêu đề</th>
                                    <th class="text-primary"
                                        style="background-color: #ffff;position: sticky; top: 0; z-index: 1;min-width: 170px;">
                                        Ngày hiệu lực</th>
                                    <th class="text-primary"
                                        style="background-color: #ffff;position: sticky; top: 0; z-index: 1;min-width: 170px;">
                                        Ngày hết <br>&nbsp;hiệu lực</th>
                                    <th class="text-primary"
                                        style="background-color: #ffff;position: sticky; top: 0; z-index: 1;min-width: 170px;">
                                        Ngày ban hành</th>
                                    <th class="text-primary"
                                        style="background-color: #ffff;position: sticky; top: 0; z-index: 1;">Nơi&nbsp;nhận</th>
                                    <th class="text-primary"
                                        style="background-color: #ffff;position: sticky; top: 0; z-index: 1;">Kiểu công văn
                                    </th>
                                    <th class="text-primary td-action"
                    ...
                    <form action="" method="" id="form-data-theses" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6 mb-3">
                                ...
                                <input type="text" id="input-published_place" name="published_place" 
                                    placeholder="Nhập nơi ban hành..." class="form-control">
                        ...
                        <div class="row mb-3">
                            <div class="col-12 col-md-6">
                                <label for="input-receiver" class="form-label">Gửi đến</label>
                                <input type="receiver" id="input-receiver" placeholder="Nhập nơi gửi đến..."
                                    name="receiver" class="form-control">
                                <div class="invalid-feedback error-receiver"></div>
                            </div>
                            <div class="col-12 col-md-6">
                        ...
                        <div class="row row mb-3">
                            <div class="col-12 col-md-6">
                                ...
                                <input class="form-control" name="archivist" type="text"
                                    placeholder="Nhập người lưu trữ..." id="input-archivist">
                            ...
                            <div class="col-12 col-md-6 mb-0">
                                ...
                                <input type="text" id="input-storage_location" name="storage_location"
                                    placeholder="Nhập nơi lưu trữ..." class="form-control">
...
@push('scripts')
    ...
    <script>
        ...
        // function validateImportExcel(data) {
        ...
        $(document).ready(function() {
            ...
            function handleImportFile(e) {
                ...
                reader.onload = function(e) {
                    ...
                    for (let i = 0; i < jsonData.length; i++) {
                        if (jsonData[i].length === 13 && isDate(jsonData[i][6])) {
                            isAccetp = true;
                            let msg = validateImportExcel(jsonData[i],2);
                            if (msg !== '') { // lỗi
                            ...
                            jsonData[i][7] = formatDate(jsonData[i][7], 'yyyy-mm-dd');
                            jsonData[i][9] = formatDate(jsonData[i][9], 'yyyy-mm-dd');
                            jsonData[i][10] = formatDate(jsonData[i][10], 'yyyy-mm-dd');
            ...
            function resetClassInput(className) {
                ...
                $('textarea[name=receiver]').removeClass(className);
            ...
            $(document).on('click', '#btn-edit', function(e) {
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    success: function(response) {
                        $('.modal-title').text('Chỉnh sửa thông tin công văn đi');
                        ...
                        $('input[name=issued_date]').val(formatDate(response.data.issued_date,
                            'yyyy-mm-dd'));
                        console.log(formatDate(response.data.issued_date));
            ...
            $(document).on('click', '#btn-create', function() {
                ...
                $('#btn-store').show();
                $('#btn-update').hide();
                $('.modal-title').text('Thêm mới công văn đi');
                emptyInput();
            });
            ...
            $(document).on('click', '#btn-reset', function(event) {
                event.preventDefault();
                window.location.href = "{{ route('dispatche.send') }}";
            })
