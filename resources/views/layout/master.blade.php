...
<body>
    ...
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
            ...
            <div class="layout-page">
                ...
                @include('layout.navbar',['cat' => 'toi la tuan'])
    ...
    {{-- <script src="https://cdn.jsdelivr.net/npm/@uvarov.frontend/vanilla-calendar@2.5.4/build/vanilla-calendar.min.js"></script> --}}
